...
<body>
	...
	<main>
		<div class="container adjust-margin"> 
			<form action="${contextPath}/job/filled">
			<div class="jumbotron"><h2>You have ${jobApplication.size()} applications for this position </h2> </div>
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
				   <c:forEach var="jobApplication" items="${jobApplication}">
					<tr>
						<td>${jobApplication.person.firstName}</td>
						<td><a href='${jobApplication.resume}' target="new"><span class="btn btn-success"><img src="${jobApplication.resume}" style="display: none;">View Resume</span></a></td>
						<td><button type="submit" class="btn btn-success" value="${jobApplication.jobApplicationID}" name="job">Select</button></td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
